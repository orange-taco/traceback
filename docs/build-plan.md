...
- 슬라이스 목표: email/password first session API를 social login과 frontend account QA가 재사용할 수 있는 backend auth contract로 안정화한다.
- 변경 파일 예산: 30개 제한 적용
